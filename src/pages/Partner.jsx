...
import HowItWorks from './PartnershipComponents/HowItWorks'
...
function Partner() {
    ...
    return (
        <div className="w-full flex flex-col bg-[#F5F5F5]">
            ...
            {/* HERO */}
            <div className=" pt-[130px] pb-5 bg-[linear-gradient(to_right,#4f4f4f0e_0.8px,transparent_0.1px),linear-gradient(to_bottom,#4f4f4f0e_0.8px,transparent_0.1px)] md:bg-[size:104px_104px] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_100%_70%_at_50%_100%,#000_70%,transparent_[200%])] overflow-hidden sm:h-[100vh] flex items-center w-full border-b">
                ...
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 px-4">
                    ...
                    >
                        ...
                        <p className="text-sm text-gray-500 mb-5">
                            ...
                            <br /> Kindly Click the button below to join our WhatsApp community for updates and support.
                        </p>
