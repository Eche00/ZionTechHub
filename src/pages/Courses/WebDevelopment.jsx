  ...
  return (
    <div className="bg-[#F5F5F5]">
      ...
      <div className="    bg-[linear-gradient(to_right,#4f4f4f0e_0.8px,transparent_0.1px),linear-gradient(to_bottom,#4f4f4f0e_0.8px,transparent_0.1px)] md:bg-[size:104px_104px] bg-[size:50px_50px] [mask-image:radial-gradient(ellipse_100%_70%_at_50%_100%,#000_70%,transparent_[200%])]   smm:h-[78vh] sm:h-[90vh]   w-full border-b">
          ...
          <div className=" flex-1   flex flex-col justify-end">
            <div className=" flex flex-col gap-[24px]">
              ...
              <p className=" text-[#1A1A1A] font-[300] sm:text-[24px] text-[18px] sm:w-[700px] w-[335px]">
                ...
                and of the data web development process.
              </p>
        ...
        <div className=" flex sm:flex-row flex-col justify-around sm:items-center  smm:max-w-[80%] max-w-[90%]  mx-auto  text-[24px] font-[400] text-[#1A1A1A] bg-[#EBECED] rounded-[10px] py-[36px] sm:px-0 px-[40px] sm:gap-0 gap-[24px] shadow-2xl">
      ...
      <div className="">
        ...
        <div className=" sm:pt-[310px] pt-[180px]  smm:max-w-[80%] md:max-w-[92%] lg:max-w-[92%] max-w-[96%] mx-auto border-l border-gray-200 relative">
        ...
        <div className=" py-[160px]  smm:max-w-[80%] md:max-w-[92%] lg:max-w-[92%] max-w-[96%] mx-auto border-l border-gray-200 relative">
        ...
        <div className=" sm:pb-[180px] pb-[100px]  smm:max-w-[80%] md:max-w-[92%] lg:max-w-[92%] max-w-[96%] mx-auto border-l border-gray-200 relative">
        ...
        {/* course content */}
        <div className=" flex flex-col  smm:max-w-[80%] md:max-w-[92%] lg:max-w-[92%] max-w-[96%] mx-auto border-l border-gray-300 ">
          <Webcontent />
        </div>

        <div className=" flex flex-col smm:max-w-[90%] sm:max-w-[96%] md:max-w-[96%] lg:max-w-[96%] xl:max-w-[98%]  ml-auto border-l border-gray-300  overflow-x-hidden">
          <CoursesTestimonial />
        </div>
        <div className=" flex flex-col  smm:max-w-[80%] md:max-w-[92%] lg:max-w-[92%] max-w-[96%] mx-auto border-l border-gray-300 ">
          <Faqs />
