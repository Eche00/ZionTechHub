...
function CourseTemplate({ 
    ...
    duration,
    courseColor = "#034FE3",
    customContent // Optional custom content component
}) {
    const dot = (
        <svg
    ...
    return (
        <div className="bg-[#F5F5F5]">
                    ...
                    <div className="flex-1 flex justify-end sm:pt-0 pt-10">
                        <div className="flex flex-col sm:gap-[34px] gap-[20px] bg-[#F1F1F1] rounded-[10px] sm:p-[23px] p-[10px] shadow-lg">
                            ...
                            <div className="flex sm:gap-[24px] gap-[12px] p-[20px] items-center justify-center">
                                <section className="p-[13px] bg-[#FFFFFF] rounded-full">{microp}</section>
                                <section className="p-[13px] bg-[#FFFFFF] rounded-full">{videocam}</section>
                                <section className="p-[13px] bg-[#FFFFFF] rounded-full">{monitor}</section>
                                <section className="p-[13px] bg-[#FFFFFF] rounded-full">{text}</section>
                                <section className="p-[13px] bg-[#FFFFFF] rounded-full">{seting}</section>
                            </div>
                        </div>
                    </div>
                </motion.div>
            ...
            {/* Custom Content (Course-specific content) */}
            {customContent && (
